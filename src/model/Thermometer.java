...
public class Thermometer implements Runnable
{
  ...
  @Override public void run()
  {
    ...
    while (running)
    {
      try
      {
        ...
        t = temperature(t, model.getHeaterPower(), d, model.getOutsideTemperature(), seconds);
   ...
   */
  public static double externalTemperature(double t0, double min, double max)
  {
    double left = t0 - min;
    double right = max - t0;
